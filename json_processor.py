...
###############################################################################
def process_data_pipeline(input_folder, output_folder):
    """
    Main processing pipeline that takes input and output folder paths
    Returns tuple of (valid_count, unknown_count)
    """
    ...
    if validDF.empty:
        return valid_count, unknown_count
